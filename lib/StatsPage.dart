  ...
  Widget build(BuildContext build) {
    return Container(
      ...
      child: SfCartesianChart(
        ...
        series: <ChartSeries>[
          BubbleSeries<DepensesData, String>(
            dataSource: depensesData,
            pointColorMapper: (DepensesData data, _) => HexColor(data.couleur),
            sizeValueMapper: (DepensesData data, _) => data.depense,
